            ...
            <div class="popup__content">
                ...
                <form class="form">
                    <div class="form__item">
                        ...
                        <input class="form__input" type="text" placeholder="Петров Василий Иванович">
                    </div>       
                    <div class="form__item">
                        <div class="form__label">Город</div>
                        <input class="form__input"  type="text" placeholder="г.Уфа">
                    </div>
                    <div class="form__item">
                    ...
                    <div class="form__item">
                        ...
                        <input class="form__input"  type="text" placeholder="tensor@mail.com"">
                    </div>                     
                </form>
                <a class="popup__button button" href="#header">Отправить</a>
            </div>
        </div>
        `              
    }
